...
export const GET_AVATAR_FOTOS = "GET_AVATAR_FOTOS";
export const DISPLAY_AVATAR = "DISPLAY_AVATAR";
export const SET_USUARIO_AVATAR = "SET_USUARIO_AVATAR";
...
export const GET_AVISOS_BY_PROF_LOGADO = "GET_AVISOS_BY_PROF_LOGADO";
